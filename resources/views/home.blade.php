    ...
    <div class="row">
        <div class="col-md-3" style="margin-bottom: 1.5em; padding: 0 1.5em;">
                <div class="box-user"  style="background: #F2F2F2; padding: 2.5em; text-align: center;">
                    <h1 style="color:#4F4F4F; font-size: 1.8em; font-weight: bold;"><span style="color: #2332A5;">Conecte-se aos melhores</span> afiliados e produtores</h1>
                    <img src="{{asset('img/conexoes.png')}}" alt="" style="margin: 0.9em;">
                </div>
            </div>
            ...
            <div class="col-md-3" style="margin-bottom: 1.5em; padding: 0 1.5em;">
                <div class="box-user"  style="background: #F2F2F2;">
                    ...
                    <div class="box-bottom" style="border-top: 1px solid #E0E0E0; text-align: center; display: block;">
                       ...
                       <div class="col-md-6" style="padding: 1em; background-color: #2332A5;">
